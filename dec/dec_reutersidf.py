...
def DisKmeans(db, update_interval = None):
    ...
    while True:
        ...
        if iters == 0:
            ...
            ret, net = extract_feature('reutersidf_net.prototxt',
            ...
            ret, net = extract_feature('reutersidf_net.prototxt', 'reutersidf_init.caffemodel', ['output'], N, True, 0)
            feature = ret[0].squeeze()
        ...
        net.save('reutersidf_init.caffemodel')
        del net

        with open('reutersidf_solver.prototxt', 'w') as fsolver:
            fsolver.write("""net: "reutersidf_net.prototxt"
                base_lr: 0.01
                lr_policy: "step"
                gamma: 0.1
                stepsize: 100000
                ...
                weight_decay: 0.0000
                snapshot: 100
                snapshot_prefix: "exp/reutersidf_test/save"
        ...
        os.system('caffe train --solver=reutersidf_solver.prototxt --weights=reutersidf_init.caffemodel')
        shutil.copyfile('exp/reutersidf_test/save_iter_%d.caffemodel'%update_interval, 'reutersidf_init.caffemodel')
...
def write_net(db, dim, n_class, seek):
    ...
    with open('reutersidf_net.prototxt', 'w') as fnet:
